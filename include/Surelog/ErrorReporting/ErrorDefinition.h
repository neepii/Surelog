...
class ErrorDefinition {
 public:
  ...
  enum ErrorType {
    ...
    LINT_COVERPOINT_EXPRESSION_TYPE = 742,
    LINT_COVERGROUP_EXPRESSION = 743,
    LINT_CONCATENATION_MULTIPLIER = 744,
    LINT_PARAMETR_OVERRIDE = 745,
    LINT_MULTIPLE_DOT_STAR_CONNECTIONS = 746,
    LINT_SELECT_IN_EVENT_CONTROL = 747,
    LINT_EMPTY_ASSIGNMENT_PATTERN = 748,
    LINT_MISSING_FOR_LOOP_INITIALIZATION = 749,
    LINT_MISSING_FOR_LOOP_CONDITION = 750,
    LINT_MISSING_FOR_LOOP_STEP = 751,
    LINT_FOREACH_LOOP_CONDITION = 752,
    LINT_SELECT_IN_WEIGHT = 753,
    LINT_ASSIGNMENT_PATTERN = 754,
    LINT_ASSIGNMENT_PATTERN_CONTEXT = 755,
    LINT_SCALAR_ASSIGNMENT_PATTERN = 756,
    LINT_TARGET_UNPACKED_ARRAY_CONCATENATION = 757,
    LINT_INSIDE_OPERATOR = 758,
    LINT_INSIDE_OPERATOR_RANGE = 759,
    LINT_TYPE_CASTING = 760,
    LINT_TIME_VALUE = 761,
    LINT_MULTIPLE_BINS = 762,
    LINT_ASSERTION_STATEMENT_ATTRIBUTE_INSTANCE = 763,
    LINT_SYSTEM_FUNCTION_ARGUMENTS = 764,
    LINT_WILDCARD_EQUALITY_OPERATOR = 765,
    LINT_WILDCARD_INEQUALITY_OPERATOR = 766,
    LINT_EXPONENT_FORMAT_TIME_VALUE = 767,
    LINT_EXTEND_CLASS = 768,
    LINT_DUPLICATE_CONSTRUCTOR = 769,
    LINT_DUPLICATE_CLASS = 770,
    LINT_EXTERN_CONSTRAINT_UNDECLARED = 771,
    LINT_EXTERN_FUNCTION_UNDECLARED = 772,
    LINT_EXTERN_TASK_UNDECLARED = 773,
    LINT_EXTEND_INTERFACE_CLASS = 774,
    LINT_IMPLEMENT_CLASS = 775,
    LINT_IMPLEMENT_INTERFACE_CLASS = 776,
    LINT_CIRCULAR_INHERITANCE = 777,
  };
